...
func init() {
	ConnectionServiceCmd.AddCommand(SetIamPolicyCmd)
...
var SetIamPolicyCmd = &cobra.Command{
	...
	Long:  "Sets the access control policy on the specified resource. Replaces any  existing policy.   Can return Public Errors: NOT_FOUND, INVALID_ARGUMENT and...",
	...
	RunE: func(cmd *cobra.Command, args []string) (err error) {
		...
		if Verbose {
			printVerboseInput("Connection", "SetIamPolicy", &SetIamPolicyInput)
		}
		resp, err := ConnectionClient.SetIamPolicy(ctx, &SetIamPolicyInput)
